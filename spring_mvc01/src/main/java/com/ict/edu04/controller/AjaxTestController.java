...
public class AjaxTestController {
	...
	public String Xml_Exam03() {
		...
		try {
	        ...
	        urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=zLfE7x1lJxYsHm9IMroSsPatZJqb3ki6P8/0nA8pwPrmeZafLSRBl3U/Q7fdpU7i59UnnySxvtgHb2l2SofxjA==");   /*자기의 서비스키 = Service Key*/
	...
	public String Json_Exam03() {
		...
		try {
	        ...
	        urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=zLfE7x1lJxYsHm9IMroSsPatZJqb3ki6P8/0nA8pwPrmeZafLSRBl3U/Q7fdpU7i59UnnySxvtgHb2l2SofxjA=="); /*Service Key*/
	        urlBuilder.append("&" + URLEncoder.encode("pageNo","UTF-8") + "=" + URLEncoder.encode("1", "UTF-8")); /*페이지번호*/
	        urlBuilder.append("&" + URLEncoder.encode("numOfRows","UTF-8") + "=" + URLEncoder.encode("10", "UTF-8")); /*한 페이지 결과 수*/
